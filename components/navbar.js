...
export default function navbar() {
    return (
        <navbar className="grid grid-cols-5 gap-2 bg-blue-600 text-white text-xl font-semibold max-h-6 px-20 mb-4">
            ...
            <Link className="col-start-2 col-end-2 bg-orange-500 rounded-b-2xl h-4 a" href="https://www.linkedin.com/in/francisco-gonzalez-449a98154/" target="_blank">
                <p>Linkedin</p>
            </Link>
            <div className="block m-auto pt-1">
                <Link className="col-start-3 col-end-3" href="/">
                    <Image className="m-auto" src={Logo} alt="Logo Cejblan" width="81" height="81" />
                </Link>
            </div>
            <Link className="col-start-4 col-end-4 bg-orange-500 rounded-b-2xl h-4 a" href="https://github.com/cejblan" target="_blank">
                <p>GitHub</p>
            </Link>
